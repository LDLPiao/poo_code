...
int Data::getMin() { return minuto; }

int Data::getSeg() { return segundo; }

long Data::getTicks() { return ticks; }

string Data::getFormato() { return formatoData.getNome(); }
...
void Data::printData() {
  if (strcmp(formatoData.getNome().c_str(), "PT-BR") == 0) {
    cout << dia << formatoData.getSeparadorData() << mes
         << formatoData.getSeparadorData() << ano << "  ";
...
string Data::getData() {
  string data = "";
  if (strcmp(formatoData.getNome().c_str(), "PT-BR") == 0) {
    data = std::to_string(dia) + formatoData.getSeparadorData() +

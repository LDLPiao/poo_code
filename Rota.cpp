...
Rota::Rota(Endereco endereco_empresa, std::list<Funcionario*> funcionarios){

    this->_funcionarios = funcionarios;
    this->_endereco_empresa = endereco_empresa;
...
std::list<Funcionario*> Rota::getFuncionarios(){return _funcionarios;}

Endereco Rota::getEnderecoEmpresa(){return _endereco_empresa;}
